...
class Window(tk.Frame):
    ...
    def convert(self):
        ...
        #reindex the cleaned columns to fit import template
        ...
        #rename and format columns to fit import template
